...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.text-center
      Para la evaluación de los requisitos o especificaciones se deben tener presente los siguientes aspectos: 
    ...
    TabsA.color-secundario.mb-5(style='position: relative')
      ...
      .tarjeta.t4-div1.p-4(titulo="Requisitos para terminación")      
        ...
        ul.lista-ul
          ...
          li 
            i.fas.fa-angle-right
            | La prenda debe presentar manchas de aceite o suciedad.
          li 
            i.fas.fa-angle-right
          ...
          li 
            i.fas.fa-angle-right
            | Seleccionar y utilizar la maquina adecuada según el tipo de prenda y operación a realizar.
          li 
            i.fas.fa-angle-right
            | Usar guías y aditamentos que favorezcan la productividad del trabajador y los costos de la empresa.
          li 
            i.fas.fa-angle-right
            | Medidas y tolerancias deben estar dentro los parámetros asignados en la ficha técnica signados por equipo de diseño y patronaje, según tabla de medidas y diseño desarrollado.
          li 
            i.fas.fa-angle-right
